...
// <div className="">
//   <div className="p-4">
//     <h1 className="font-semibold pl-5 text-[#eab308]">List of Songs</h1>

//     <ul className="flex flex-col items-center mx-5">
//       {songs.map((song, index) => (
//         <li
//           key={index}
//           className="flex justify-between items-center w-full my-2 cursor-pointer bg-slate-400 px-3 py-3 rounded-md"
//           onClick={() => {
//             setTrackIndex(index);
//             setIsPlay(true);
//           }}
...
//           <p className="text-[#fff18a] ">{song.name.slice(0, -4)}</p>
//           <button
//             onClick={() => {
//               setTrackIndex(index);
//               setIsPlay(true);
//             }}
//             className="mx-2 bg-[#eab308] text-white px-3 py-1 rounded-lg cursor-pointer"
//           >
//             Play
//           </button>
//         </li>
